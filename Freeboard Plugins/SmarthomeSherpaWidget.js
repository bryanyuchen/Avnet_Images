(function()
{
    ...
    var SmarthomeSherpa = function (settings) {
        ...
        var width, height;
        var currentValue = 0;
        var valueDiv = $('<p style="font-size:62px; color: rgb(212,212,212); position:relative; left:-10px; top: -50px; align: center;"><img src = 'https://c1.staticflickr.com/5/4158/33781839124_3a8cfff44b_z.jpg' style='width:100%'></p>');
        ...
        this.render = function (element) {
            ...
            $(element).append($('<div class="pointer-value"><img src = "https://raw.githubusercontent.com/bryanyuchen/Avnet_Images/master/sstoponnew.gif" style="width:100%"></div>').append(valueDiv).append(unitsDiv));
        }
